...
> 状态：MVP 1.0 范围已冻结，MVP-I1 候选版本已交付，持续迭代中  
> 最近更新：2026-08-19
...
- MVP 1.0 范围已经冻结，MVP-I1 候选版本已交付（版本 `0.1.0-SNAPSHOT`），并持续完成多轮修复与增强；
- 已交付管理员登录、端管理、多数据源、Table/SQL 任务、预检/启用、首次全量/手动增量（含双阶段增量策略）、暂停/继续/安全重试、Sink Token 轮换与批次认证；
- 已交付 UPSERT / UPSERT_NO_OVERWRITE / INSERT_ONLY / REPLACE_ALL 四种写入模式与软唯一键；
